...
#define VERBOSE FALSE            /* MP: pre-processor disabled -- as if always FALSE */
...
/***** If TRUE include all debugging code - debugging options still
       ...
       code *****/
#define LINK_DEBUG FALSE         /* MP: pre-processor disabled -- as if always FALSE */
...
#define QUICK_FS FALSE           /* MP: pre-processor disabled -- as if always FALSE */
