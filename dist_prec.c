...
storm_track_struct dist_prec(atmos_data_struct   *atmos,
...
**********************************************************************/
  ...
  if(options.DIST_PRCP) {
    ...
    *******************************************/
    ...
    full_energy(rec, atmos, soil_con, veg_con, prcp, dmy, global_param, veg_lib);
  ...
  **************************************************/
  ...
  tmp_storm.still_storm = STILL_STORM;
  tmp_storm.dry_time    = DRY_TIME;
