...
double calc_surf_energy_bal(int, int, int, int, int, int, int, int, int, 
			    ...
			    soil_con_struct *, dmy_struct *, veg_lib_struct *);
...
double canopy_evap(layer_data_struct *, layer_data_struct *,
		   ...
		   double, double *, double, double, double, double, 
		   double, double,  double, double, double, double, 
		   double *, double *, double *, double *, float *, veg_lib_struct *);
void   check_files(infiles_struct *, filenames_struct *);
FILE  *check_state_file(char *, dmy_struct *, global_param_struct *, int, int, 
                        int *);
gzFile check_state_file_gzip(char *, dmy_struct *, global_param_struct *, int, int,
                             int *);
...
void   copy_dist_prcp(dist_prcp_struct *, dist_prcp_struct *, int);
...
storm_track_struct dist_prec(atmos_data_struct *,dist_prcp_struct *,soil_con_struct *,
		             veg_con_struct *,dmy_struct *,global_param_struct *,
		             outfiles_struct *,int,char, char, int, int, veg_lib_struct *);
#if QUICK_FS
...
/** Gridded Input **/
float **read_once_nldas_forcing(filenames_struct *);
float **read_once_netcdf_forcing(filenames_struct *);
void   read_initial_model_state(FILE *, dist_prcp_struct *, 
				global_param_struct *, int, int, int, 
				soil_con_struct *, int, char *, int *);
void   read_initial_model_state_ascii(FILE *, dist_prcp_struct *,
                                      global_param_struct *, int, int, int,
                                      soil_con_struct *, int, char *, int *);
void   read_initial_model_state_ascii_gzip(gzFile, dist_prcp_struct *,
                                           global_param_struct *, int, int, int,
                                           soil_con_struct *, int, char *, int *);
void   read_initial_model_state_binary(FILE *, dist_prcp_struct *,
                                       global_param_struct *, int, int, int,
                                       soil_con_struct *, int, char *, int *);
void   read_initial_model_state_binary_gzip(gzFile, dist_prcp_struct *,
                                            global_param_struct *, int, int, int,
                                            soil_con_struct *, int, char *, int *);
...
void   surface_fluxes(char, int, int, int, int, int, int, int, int, int, 
		      ...
		      layer_data_struct *, layer_data_struct *, 
		      veg_var_struct *, veg_var_struct *, veg_lib_struct *);
double svp(double);
...
void write_data_netcdf(out_data_struct *, filenames_struct *, global_param_struct *, int, int, int);
...
void write_model_state(dist_prcp_struct *, global_param_struct *, int, 
		       int, outfiles_struct *, soil_con_struct *, char, int, dmy_struct);
void write_model_state_ascii(dist_prcp_struct *, global_param_struct *, int,
                             int, outfiles_struct *, soil_con_struct *, char, int, dmy_struct);
void write_model_state_ascii_gzip(dist_prcp_struct *, global_param_struct *, int,
                                  int, outfiles_struct *, soil_con_struct *, char, int, dmy_struct);
void write_model_state_binary(dist_prcp_struct *, global_param_struct *, int,
                              int, outfiles_struct *, soil_con_struct *, char, int, dmy_struct);
void write_model_state_binary_gzip(dist_prcp_struct *, global_param_struct *, int,
                                   int, outfiles_struct *, soil_con_struct *, char, int, dmy_struct);
