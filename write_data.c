...
***************************************************************/
  ...
  static int    Nrecs;
  #pragma omp threadprivate(last_storage, cum_error, max_error, error_cnt, Nrecs)
  {
...
//	      cum_error);
  ...
  } // end of #pragma omp threadprivate
...
***************************************************************/
  ...
  static double max_error;
  static int    Nrecs;
  #pragma omp threadprivate(cum_error, max_error, Nrecs)
  {
